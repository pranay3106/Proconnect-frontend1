...
//main dashboard which gonna render
...
//   if (token) {
//     dispatch(setTokenThere());  // ✅ THIS is missing in your current setup
//   }
// }, []);
       ...
       <DashboardLayout>
        ...
        <div className={styles.scrollComponenet}>
            <div className={styles.Wrapper}>
                ...
                <img  className={styles.userProfile} src={`${Base_Url}/uploads/${authState.user.profilePicture}`} alt="" />
                <textarea onChange={(e)=>{
                    setPostContent(e.target.value)
                }} value={postContent} name="" className={styles.textAreaContent}  placeholder="What's in your mind"id=""></textarea>
                ...
                return(
                    <div key={post._id} className={styles.singleCard}>
                        <div className={styles.singleCard_profileContainer} >
                            <img  className={styles.userProfile}src={`${Base_Url}/uploads/${post.userId?.profilePicture || "default.jpg"}`} alt="profile" />
                       <div>

                        <div style={{display:"flex",gap:"1.2rem",justifyContent:"space-between",cursor:"pointer"}}>
                        <p style={{fontWeight:"bold"}}>{post.userId && post.userId.name ? post.userId.name : "Unknown User"}</p>
                        {
                        ...
                        console.log("postsssss:", post);
                         ...
                         await dispatch(getAllPosts())
                            ...
                            <svg  style={{height:"1.2rem",color:"red"}}xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        ...
                        <div className={styles.singleCard_img}>
                            ...
                            :
                            <div style={{width:"1.4rem",height: "1.4rem"}}> </div>}
                        </div>
        ...
        >
                    ...
                    {postState.comments.map((comment, index) => (
                        <div className={styles.singleComment} key={comment._id}>
                            ...
                            <p style={{ fontWeight: "bold", fontSize: "1.2rem" }}>
                                {console.log("this is what i want : ",comment.userId.username)}
            ...
            <div className={styles.postCommentContainer}>
                <input
                    ...
                    value={commentText}
                    placeholder='Comment'
                    onChange={(e) => setCommentText(e.target.value)} // FIXED from `onClick`
                />
                <div
                    onClick={async () => {
                        await dispatch(postComment({ post_id: postState.post_id, body: commentText }));
                        await dispatch(getAllComments({ post_id: postState.post_id }));
